...
<nav>
    ...
    <div class="nav-links">
        ...
        <a href="cadastro_autor.php" class="<?php if($ativo == "cadastro_autor.php") echo "ativo";?>">Cadastro de Autor</a>
        <a href="cadastro_editora.php" class="<?php if($ativo == "cadastro_editora.php") echo "ativo";?>">Cadastro de Editora</a>
